...
void computeXYPossition_win4(const int channel_id, int &x_offset,
                             int &y_offset) {
  if (channel_id == 0) {
    x_offset = 0;
    y_offset = 0;
...
void computeXYPossition_win5(const int channel_id, int &x_offset,
                             int &y_offset) {
  if (channel_id == 0) {
    x_offset = 0;
    y_offset = 0;
...
void DisplayInfo::computeXYPossition(const int dispaly_mode,
  ...
  switch (win_num) {
    ...
    case 4:
      computeXYPossition_win4(channel_id, x_offset, y_offset);
      break;
    case 5:
      computeXYPossition_win5(channel_id, x_offset, y_offset);
      break;
    case 9:
      computeXYPossition_win9(channel_id, x_offset, y_offset);
      break;
    default: {
      x_offset = 0;
      y_offset = 0;
